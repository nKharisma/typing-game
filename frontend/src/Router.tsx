...
import GameLevelFive from './pages/GameLevelFive'
import GameLevelSix from './pages/GameLevelSix'
        ...
        children: [
          ...
          { path: '/validate-password-reset', element: <ValidatePasswordResetPage /> },
          {
            ...
            children: [
              ...
              { path: '/dashboard/game-level-5', element: <GameLevelFive /> },
              { path: '/dashboard/game-level-6', element: <GameLevelSix /> }
            ]
          },
